...
class MilliRules {
	 ...
	 * @param array<string, mixed>      $context          Execution context, or empty array for auto-build from packages.
	 * @return array<string, mixed> Execution result with statistics and context.
	 */
	public static function execute_rules( ?array $allowed_packages = null, array $context = array() ): array {
		try {
	 ...
	 * Merges context data from all loaded packages into a single array.
	 *
	 * @since 1.0.0
	 *
	 * @return array<string, mixed> Aggregated context with data from all loaded packages.
	 */
